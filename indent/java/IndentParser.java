...
public class IndentParser extends Parser {
	...
	public static class CommandEmptyLineContext extends CommandsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IndentVisitor ) return ((IndentVisitor<? extends T>)visitor).visitCommandEmptyLine(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CommandIfContext extends CommandsContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof IndentVisitor ) return ((IndentVisitor<? extends T>)visitor).visitCommandIf(this);
			else return visitor.visitChildren(this);
		}
	}
